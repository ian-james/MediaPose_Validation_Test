...
def main():
    ...
    min_detection_con = mediapipe_expander.slider("Minimum detection confidence",min_value=0.0, max_value=1.0, value=0.8, step=0.1)

    min_tracking_con = mediapipe_expander.slider("Minimum tracking confidence", min_value=0.0, max_value=1.0, value=0.8, step=0.1)

    desired_fps = mediapipe_expander.number_input("FPS", min_value=0, max_value=60, value=0, step=1)
